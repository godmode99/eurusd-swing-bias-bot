...
def main() -> None:
    parser = argparse.ArgumentParser(description="Filter CME watchlist (weekly)")
    parser.add_argument(
        "--watchlist",
        type=Path,
    ...
    build_filtered_watchlists(
        watchlist_path,
        output_dirs={"weekly": DEFAULT_FILTERED_DIRS["weekly"]},
        prefix_map={"weekly": FILTER_PREFIXES["weekly"]},
    )
