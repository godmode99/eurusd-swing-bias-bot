...
def main() -> None:
    parser = argparse.ArgumentParser(description="Filter CME watchlist (daily)")
    parser.add_argument(
        "--watchlist",
        type=Path,
    ...
    build_filtered_watchlists(
        watchlist_path,
        output_dirs={"daily": DEFAULT_FILTERED_DIRS["daily"]},
        prefix_map={"daily": FILTER_PREFIXES["daily"]},
    )
