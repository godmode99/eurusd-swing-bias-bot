...
# -------------------------------------------------------------------
# main.py location: <repo_root>/python/fetch/mt5/main.py
...
PYTHON_DIR = BASE_DIR.parents[1].resolve()         # .../python  (FIXED)
...
# Local imports (assumes these files are in the same folder as main.py)
