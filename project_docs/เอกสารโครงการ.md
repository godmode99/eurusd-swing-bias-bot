...
price returns near level within tolerance (e.g., abs(Low[0]-level) < 0.2\*ATR for LONG)
...
log a row for the partial deal (pnl_r = realized_pnl_money / R_money)
Final close:
