...
This is a “fuse” not market prediction.
...
One open position at a time (for EURUSD, magic number).
...
log a row for the partial deal (pnl_r based on realized money / R_money)
Final close:
